...
FROM (
 	...
 	(SELECT "fellesegenskaper.forstedatafangsdato", "fellesegenskaper.verifiseringsdato", "fellesegenskaper.oppdateringsdato","fellesegenskaper.opphav","fellesegenskaper.kvalitet.maalemetode") as l
 	)) || 
 	'}' as a
	FROM 
	( 
	SELECT 
			...
			produsent as "fellesegenskaper.opphav",
...
FROM (
	...
	FROM (
		...
		FROM ( 
			...
			"fellesegenskaper.forstedatafangsdato", "fellesegenskaper.verifiseringsdato", "fellesegenskaper.oppdateringsdato","fellesegenskaper.opphav","fellesegenskaper.kvalitet.maalemetode"
...
FROM (
 	...
 	'"properties":' || row_to_json((SELECT l FROM (SELECT reinbeitebruker_id, reindriftsanleggstype, "fellesegenskaper.forstedatafangsdato", "fellesegenskaper.verifiseringsdato", "fellesegenskaper.oppdateringsdato","fellesegenskaper.opphav","fellesegenskaper.kvalitet.maalemetode") As l )) || '}' as a,

...
SELECT '03_02_query_to_topojson_bb' , * from topo_update.query_to_topojson('select distinct a.id , a.reindrift_sesongomrade_kode, a.omrade from topo_rein.arstidsbeite_var_topojson_flate_v  a ',25832,0,0,'SRID=4258;POLYGON((18.3052533657 69.1926352514,18.3052533657 69.2158024362,18.3695071064 69.2158024362,18.3695071064 69.1926352514,18.3052533657 69.1926352514))');
SELECT '03_02_query_to_topojson' , * from topo_update.query_to_topojson('select distinct a.id , a.reindrift_sesongomrade_kode, a.omrade from topo_rein.arstidsbeite_var_topojson_flate_v  a WHERE a.id in (1)',25832,0,0);
SELECT '03_02_as_topo_json', topo_update.as_topo_json(a.omrade,null,null) from topo_rein.arstidsbeite_var_topojson_flate_v  a WHERE a.id in (1);
SELECT '03_02_AsTopoJSON_org', AsTopoJSON(a.omrade,null) from topo_rein.arstidsbeite_var_topojson_flate_v  a WHERE a.id in (1);

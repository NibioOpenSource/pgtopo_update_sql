...
SELECT '12', t.id,  ROUND(ST_length(t.linje) l1, ST_Length(t.linje::geometry(MultiLineString,4258))::numeric,15), ST_Srid(t.linje::geometry(MultiLineString,4258)) from topo_rein.reindrift_anlegg_linje t;

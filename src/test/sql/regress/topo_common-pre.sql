...
--select * from topo_rein.arstidsbeite_host_topojson_flate_v-- DROP VIEW topo_rein.arstidsbeite_sommer_flate_v cascade ;
...
--select * from topo_rein.arstidsbeite_var_topojson_flate_vDROP VIEW IF EXISTS topo_rein.rein_trekklei_topojson_linje_v cascade ;

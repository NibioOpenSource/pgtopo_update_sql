...
SELECT '4', reinbeitebruker_id , reindriftsanleggstype FROM topo_rein.reindrift_anlegg_linje ;
...
SELECT '12', reinbeitebruker_id , reindriftsanleggstype FROM topo_rein.reindrift_anlegg_linje ;
SELECT '13', topo_update.apply_attr_on_topo_line('{"properties":{"id":1,"reinbeitebruker_id":"ZH"}}','topo_rein', 'rein_trekklei_linje', 'linje');
SELECT '14', reinbeitebruker_id , reindriftsanleggstype FROM topo_rein.reindrift_anlegg_linje ;
SELECT '15', topo_update.delete_topo_line(1,'topo_rein', 'rein_trekklei_linje', 'linje');
SELECT '16', reinbeitebruker_id , reindriftsanleggstype FROM topo_rein.reindrift_anlegg_linje ;
